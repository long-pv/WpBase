...
require get_template_directory() . '/inc/woo/checkout.php';
require get_template_directory() . '/inc/woo/thankyou.php';
require get_template_directory() . '/inc/woo/product.php';
require get_template_directory() . '/inc/woo/login.php';
